...
func (t *GitStatus) Capabilities() tools.CapabilitySet {
	return tools.CapabilityReadWorkspace | tools.CapabilityExecuteProcess
}

func (t *GitStatus) Description() string {
	return "Shows the current branch and bounded staged, modified, and untracked file status without changing the repository."
}
...
func (t *GitStatus) Execute(ctx context.Context, input any) (*tools.ToolResult, error) {
	...
	return tools.BuildSerializedToolResult(true, "Git status retrieved", outputData), nil
}
